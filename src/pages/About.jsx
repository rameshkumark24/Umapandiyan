      ...
      <div className="min-h-screen py-20 font-body">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          duration: 0.8
            ...
            <h1 className="text-3xl md:text-4xl font-heading font-bold text-gradient mb-6 max-w-4xl mx-auto leading-snug">"Pain isn't the end — it's the beginning of evolution."</h1>
