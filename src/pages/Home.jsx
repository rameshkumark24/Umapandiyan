        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            duration: 0.8
              ...
              <motion.h2 className="text-4xl md:text-6xl font-heading font-bold text-gradient mb-6" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
              ...
              duration: 0.8,
              delay: 0.2
            }}>No more Procrastination, only Transformation.</motion.h2>
              
              <motion.p className="text-lg md:text-xl text-gray-600 mb-8 max-w-2xl" initial={{
              opacity: 0,
              y: 20
            }} animate={{
              opacity: 1,
              ...
              delay: 0.4
                ...
                To empower individuals to overcome emotional, physical, and spiritual blocks — and to guide them toward a fulfilled, purpose-driven life.
              </motion.p>
              ...
              delay: 0.6
                ...
                <Link to="/about">
                  <Button variant="outline" className="border-accent-gold text-accent-gold hover:bg-accent-gold hover:text-white px-8 py-3 text-border-[#B8860B] text-[#B8860B] hover:bg-[#B8860B] hover:text-white px-8 py-3 text-lg">
                    Learn More About Me
                  </Button>
                </Link>
              </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            icon: Zap,
            title: "Personal Breakthrough Sessions"
          }, {
            icon: Sunrise,
            title: "Spiritual Mentoring"
          }, {
            icon: Sparkles,
            title: "Relationship healing and coaching",
            description: "Based on personal needs"
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          once: true
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Take the first step towards a more balanced, peaceful, and fulfilling life. Book your personalized holistic therapy session today.
            </p>
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSeZMmTnBnXvEx86B3K_aUfscQ0h7WAtWAAXurrYfwAcDeCeoQ/viewform?usp=header" target="_blank" rel="noopener noreferrer">
